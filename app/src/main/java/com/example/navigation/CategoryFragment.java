    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnCategoryLifestyle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CategoryFragmentDirections.ActionCategoryFragment2ToDetailCategoryFragment toDetailCategoryFragment = CategoryFragmentDirections.actionCategoryFragment2ToDetailCategoryFragment();
...
//                Navigation.findNavController(view).navigate(R.id.action_categoryFragment2_to_detailCategoryFragment);
            }
        });
    }
}
